...
<section class="text-gray-500 bg-gray-900 body-font">
    <div class="container px-5 pt-5 mx-auto flex flex-wrap md:w-2/3 md:border-solid md:border-b">
        <div class="flex flex-col flex-wrap lg:py-6 text-center md:mx-auto border-b border-solid md:border-none">
            <div class="flex flex-col pb-8 lg:items-start items-center">
                <div class="w-12 h-12 mx-auto inline-flex items-center justify-center rounded-full bg-gray-800 text-purple-400 mb-5">
                    <img class="h-8" {src}>
                </div>
                <div class="flex-grow">
                    <h2 class="text-white text-lg title-font font-medium mb-3 capitalize text-5xl">the best price every
                        time</h2>
                    <div class="pb-5">
                    <p class="leading-relaxed text-base text-3xl">Make your gold go farther with convenient
                ...
                <div class="flex justify-around">
                    ...
                    <a target="_blank"
                       ...
                       href="https://discord.gg/Jv2DpfzXNC">
                        ...
                        <p class="mt-auto mb-auto">Join the Server</p>
                    </a>
                </div>
            </div>
        </div>
