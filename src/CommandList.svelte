                ...
                <div class="flex-grow md:pl-8 flex sm:items-center items-start flex-col sm:flex-row">
                    ...
                    <div class="flex-grow sm:pl-6 mt-6 sm:mt-0">
                        ...
                        <p class="leading-relaxed">Simply type !r &#123;realm&#125; and hit enter. A few examples:
                            ...
                            <br>
                            <code class="text-purple-300">!r moon guard</code> for a two word server name on US region.
                            <br>
            ...
            <div class="flex relative pl-2 pb-20 sm:items-center">
                ...
                <div class="flex-grow md:pl-8 flex sm:items-center items-start flex-col sm:flex-row">
                    ...
                    <div class="flex-grow sm:pl-6 mt-6 sm:mt-0">
                        ...
                        <ul>
                            <li><span class="italic">Shadowlands</span> legendary items can be searched by rank! Use <code>/rank #</code> for
                                example
                                <br>
                            ...
                            <li>
                                ...
                                palat</code> and <code class="text-purple-300">!bg+ hedon</code> for <span class="italic">Shadowlands</span> feasts.
                            </li>
                        </ul>
                    </div>
                </div>
