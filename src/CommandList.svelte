            ...
            <div class="w-9/12">
                ...
                <div class="flex relative pl-2 pt-10 pb-20 sm:items-center">
                    ...
                    <div class="flex-grow md:pl-8 flex sm:items-center items-start flex-col sm:flex-row">
                        ...
                        <div class="flex-grow sm:pl-6 mt-6 sm:mt-0">
                            <h2 class="font-medium title-font text-white mb-1 text-xl">Quick Help</h2>
                            <p class="leading-relaxed">Get all the info you could possibly need on all the other
                                commands
                                the
                ...
                <div class="flex relative pl-2 pb-20 sm:items-center">
                    ...
                    <div class="flex-grow md:pl-8 flex sm:items-center items-start flex-col sm:flex-row">
                        ...
                        <div class="flex-grow sm:pl-6 mt-6 sm:mt-0">
                            <h2 class="font-medium title-font text-white mb-1 text-xl">Pick a Realm, any Realm</h2>
                            <p class="leading-relaxed">Simply type !r &#123;realm&#125; and hit enter. A few examples:
                                <br>
                                <code class="text-purple-300">!r arthas</code> or <code class="text-purple-300">!r
                                    arthas-us</code> for Arthas on US region.
                                <br>
                                <code class="text-purple-300">!r moon guard</code> for a two word server name on US
                                region.
                                <br>
                                <code class="text-purple-300">!r r grim batol-eu</code> for a two word server name on EU
                                region
                            </p>
                        </div>
                    </div>
                ...
                <div class="flex relative pl-2 pb-20 sm:items-center">
                    ...
                    <div class="flex-grow md:pl-8 flex sm:items-center items-start flex-col sm:flex-row">
                        ...
                        <div class="flex-grow sm:pl-6 mt-6 sm:mt-0">
                            <h2 class="font-medium title-font text-white mb-1 text-xl">Item Stats Instantly</h2>
                            <p class="leading-relaxed">Get key stats and information on any item on the Auction
                                House.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="flex relative pl-2 pb-10 sm:items-center">
                    ...
                    <div class="flex-grow md:pl-8 flex sm:items-center items-start flex-col sm:flex-row">
                        ...
                        <div class="flex-grow sm:pl-6 mt-6 sm:mt-0">
                            <h2 class="font-medium title-font text-white mb-1 text-xl">Master of the Craft</h2>
                            <p class="leading-relaxed pb-2">Every item in a craftable item's recipe and item in the
                                those
                                item's
                                recipes and so on.</p>
                ...
                <div class="flex relative pl-2 pb-20 sm:items-center">
                    ...
                    <div class="flex-grow md:pl-8 flex sm:items-center items-start flex-col sm:flex-row">
                        ...
                        <div class="flex-grow sm:pl-6 mt-6 sm:mt-0">
                            <h2 class="font-medium title-font text-white mb-1 text-xl">Other tips and tricks:</h2>
                            <ul>
                                <li><span class="italic">Shadowlands</span> legendary items can be searched by rank! Use
                                    <code>/rank #</code> for
                                    example
                                    <br>
                                    <code class="text-purple-300">!p shadowghast ring /rank 4</code>
                                    <br>
                                    You can even combine your favorite shorthand with the rank command such as <code
                                            class="text-purple-300">!p
                                        shadowghast r /rank 1</code>.
                                    <br>
                                </li>
                                <li>
                                    Two of our favorite short hand commands are <code class="text-purple-300">!bg+
                                    palat</code> and <code class="text-purple-300">!bg+ hedon</code> for <span
                                        class="italic">Shadowlands</span> feasts.
                                </li>
                            </ul>
                        </div>
                    </div>
