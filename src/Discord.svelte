    ...
    <div class="container px-5 pt-5 mx-auto flex flex-wrap md:w-2/3 md:border-solid md:border-b">
        <div class="flex flex-col flex-wrap lg:py-6 text-center md:mx-auto border-b border-solid md:border-none">
            <div class="flex flex-col pb-12 lg:items-start items-center">
                ...
                <div class="flex-grow">
                    <h2 class="text-white text-lg title-font font-medium mb-3 capitalize text-4xl">the best price every
                        time</h2>

                    <p class="leading-relaxed text-base pb-5 text-xl">Make your gold go farther with convenient
